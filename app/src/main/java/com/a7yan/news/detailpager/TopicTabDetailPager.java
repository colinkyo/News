...
public class TopicTabDetailPager extends DetailBasePager {
    ...
    public TopicTabDetailPager(Context context, NewsCenterPagerBean.NewsCenterPagerData.ChildrenData childrenData) {
        super(context);
    ...
    public View initView() {
        ...
        return textView;*/
        View view = View.inflate(mContext, R.layout.topic_tab_detail_pager, null);
